...
class Quant_Strategy_5(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.ma_80 = bt.ind.SMA(self.data, period= 80)
        ...
        self.buy_signal = bt.And(self.ma_20(0) > self.ma_20(-1), self.ma_40(-1) < self.ma_80(-1), self.ma_40(0) > self.ma_80(0))
        self.sell_signal = bt.And(self.ma_20(0) < self.ma_20(-1), self.ma_40(-1) > self.ma_80(-1), self.ma_40(0) < self.ma_80(0))

        self.long_exit = bt.And(self.ma_40(-1) > self.ma_80(-1), self.ma_40(0) < self.ma_80(0))
        self.short_exit = bt.And(self.ma_40(-1) < self.ma_80(-1), self.ma_40(0) > self.ma_80(0))
